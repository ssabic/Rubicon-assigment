...
export class MoviesComponent implements OnInit {
  ...
  getMovies() {
    this.httpClient.get<any>('https://api.themoviedb.org/3/movie/top_rated?api_key=0b578984fcad327dcbf90ee3130faa4d&language=en-US&page=1').subscribe(
      response => {
  ...
  redirect() {
    window.location.href = 'movies/overview';
  }
}
